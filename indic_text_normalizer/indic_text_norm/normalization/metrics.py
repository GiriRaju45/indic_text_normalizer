...
bi_syl_regex['te'] = r'\s[౦-౯]+/?\.?[౦-౯]*?\s?\.?{}\.?\s?{}\.?\s|^[౦-౯]+/?\.?[౦-౯]*\s\.?{}\s?\.?{}\.?\s|\s[౦-౯]+/?\.?[౦-౯]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['kn'] = r'\s[೦-೯]+/?\.?[೦-೯]*?\s?\.?{}\.?\s?{}\.?\s|^[೦-೯]+/?\.?[೦-೯]*\s\.?{}\s?\.?{}\.?\s|\s[೦-೯]+/?\.?[೦-೯]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['gu'] = r'\s[૦-૯]+/?\.?[૦-૯]*?\s?\.?{}\.?\s?{}\.?\s|^[૦-૯]+/?\.?[૦-૯]*\s\.?{}\s?\.?{}\.?\s|\s[૦-૯]+/?\.?[૦-૯]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['mn'] = r'\s[꯰-꯹]+/?\.?[꯰-꯹]*?\s?\.?{}\.?\s?{}\.?\s|^[꯰-꯹]+/?\.?[꯰-꯹]*\s\.?{}\s?\.?{}\.?\s|\s[꯰-꯹]+/?\.?[꯰-꯹]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['or'] = r'\s[୦-୯]+/?\.?[୦-୯]*?\s?\.?{}\.?\s?{}\.?\s|^[୦-୯]+/?\.?[୦-୯]*\s\.?{}\s?\.?{}\.?\s|\s[୦-୯]+/?\.?[୦-୯]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['ur'] = r'[۰-۹]+/?\.?[۰-۹]*?\s*(?:{}\s*?{}|{}\s*?{})|^[۰-۹]+/?\.?[۰-۹]*?\s*(?:{}\s*?{}|{}\s*?{})|[۰-۹]+/?\.?[۰-۹]*?\s*(?:{}\s*?{}|{}\s*?{})$|[0-9]+/?\.?[0-9]*?\s*(?:{}\s*?{}|{}\s*?{})|^[0-9]+/?\.?[0-9]*?\s*(?:{}\s*?{}|{}\s*?{})|[0-9]+/?\.?[0-9]*?\s*(?:{}\s*?{}|{}\s*?{})$|'
bi_syl_regex['ks'] = r'[۰-۹]+/?\.?[۰-۹]*?\s*(?:{}\s*?{}|{}\s*?{})|^[۰-۹]+/?\.?[۰-۹]*?\s*(?:{}\s*?{}|{}\s*?{})|[۰-۹]+/?\.?[۰-۹]*?\s*(?:{}\s*?{}|{}\s*?{})$|[0-9]+/?\.?[0-9]*?\s*(?:{}\s*?{}|{}\s*?{})|^[0-9]+/?\.?[0-9]*?\s*(?:{}\s*?{}|{}\s*?{})|[0-9]+/?\.?[0-9]*?\s*(?:{}\s*?{}|{}\s*?{})$|'
bi_syl_regex['as'] = r'\s[০-৯]+/?\.?[০-৯]*?\s?\.?{}\.?\s?{}\.?\s|^[০-৯]+/?\.?[০-৯]*\s\.?{}\s?\.?{}\.?\s|\s[০-৯]+/?\.?[০-৯]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['bn'] = r'\s[০-৯]+/?\.?[০-৯]*?\s?\.?{}\.?\s?{}\.?\s|^[০-৯]+/?\.?[০-৯]*\s\.?{}\s?\.?{}\.?\s|\s[০-৯]+/?\.?[০-৯]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['sat'] = r'\s[᱐-᱙]+/?\.?[᱐-᱙]*?\s?\.?{}\.?\s?{}\.?\s|^[᱐-᱙]+/?\.?[᱐-᱙]*\s\.?{}\s?\.?{}\.?\s|\s[᱐-᱙]+/?\.?[᱐-᱙]*\s?\.?{}\s?\.?{}\.?$|\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['en'] = r'\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'
bi_syl_regex['ta'] = r'\s[0-9]+/?\.?[0-9]*?\s?\.?{}\.?\s?{}\.?\s|^[0-9]+/?\.?[0-9]*\s\.?{}\s?\.?{}\.?\s|\s[0-9]+/?\.?[0-9]*\s?\.?{}\s?\.?{}\.?$|'

dvn = ['brx', 'dgr', 'hi', 'mr', 'knk', 'np', 'sa', 'sin'] #mai
...
def create_all_regex_metrics(lang, dic: dict):
    ...
    for key in key_metrics:
        ...
        for char in ["{}".format(key)]:
            ...
            if lang == "sa" and len(finds) == 4:
                fst_syl, scnd_syl = finds[:2], finds[:2]
                pattern += bi_syl_regex['sa'].format(fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl)#f"\s[0-9]+/?\.?[0-9]*\s?\.?{x}\.?{y}\.?\s|^[0-9]*\.?[0-9]*\s?\.?{x}\.?{y}\.?\s|\s[0-9]*\.?[0-9]*\s?\.?{x}\.?{y}\.?$|"
                r += pattern
            
            # Kashmiri/Urdu language regex creation for metrices with 2 characters
            elif (lang == 'ks' or lang == 'ur') and len(finds) == 2 and key not in bi_char_exp:
                fst_syl, scnd_syl = key[0], key[1]
                pattern = bi_syl_regex['ur'].format(fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl,fst_syl, scnd_syl)
                r += pattern

            # Kashmiri/Urdu language regex creation for the square equivalent
            elif (lang == 'ks' or lang == 'ur') and find_sq(key) is not None:
            ...
            elif (lang == 'ks' or lang == 'ur') and key in ks_single:
